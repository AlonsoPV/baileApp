-- ============================================================================
-- 🔒 ELIMINAR SECURITY DEFINER DE VISTAS PÚBLICAS
-- ============================================================================
-- Este script corrige los errores del linter de Supabase eliminando
-- SECURITY DEFINER de todas las vistas públicas.
-- 
-- Las vistas deben usar SECURITY INVOKER (por defecto) para que respeten
-- las políticas RLS del usuario que consulta, no del creador de la vista.
-- ============================================================================
...
-- ============================================================================
-- PARTE 2: RECREAR VISTAS SIN SECURITY DEFINER (SECURITY INVOKER por defecto)
-- ============================================================================
...
-- NOTAS:
-- ============================================================================
-- ✅ Todas las vistas han sido recreadas sin SECURITY DEFINER
-- ✅ Por defecto, las vistas usan SECURITY INVOKER (respeta RLS del usuario)
-- ✅ Se han otorgado permisos SELECT a 'anon' y 'authenticated' según corresponda
-- ✅ Esto corrige los 18 errores del linter de Supabase relacionados con
--    vistas que tenían SECURITY DEFINER
-- ============================================================================
