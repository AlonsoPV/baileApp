...
echo "==> Creating .env file for app.config.ts (from Xcode Cloud environment variables)"
{
  ...
  [ -n "$EXPO_PUBLIC_SUPABASE_URL" ] && echo "EXPO_PUBLIC_SUPABASE_URL=$EXPO_PUBLIC_SUPABASE_URL"
  [ -n "$EXPO_PUBLIC_SUPABASE_ANON_KEY" ] && echo "EXPO_PUBLIC_SUPABASE_ANON_KEY=$EXPO_PUBLIC_SUPABASE_ANON_KEY"
  [ -n "$EXPO_PUBLIC_GOOGLE_IOS_CLIENT_ID" ] && echo "EXPO_PUBLIC_GOOGLE_IOS_CLIENT_ID=$EXPO_PUBLIC_GOOGLE_IOS_CLIENT_ID"
  [ -n "$EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID" ] && echo "EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID=$EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID"
  [ -n "$EXPO_PUBLIC_GOOGLE_SIGNIN_DEBUG" ] && echo "EXPO_PUBLIC_GOOGLE_SIGNIN_DEBUG=$EXPO_PUBLIC_GOOGLE_SIGNIN_DEBUG"
} > "$ENV_FILE"
...
if [ -f "$ENV_FILE" ]; then
  ...
  echo "⚠️  WARNING: .env file was not created at $ENV_FILE"
fi
