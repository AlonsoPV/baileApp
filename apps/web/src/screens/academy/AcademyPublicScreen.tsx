              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <motion.span
                  ...
                  style={{
                    ...
                    color: '#FFFFFF', fontSize: '0.875rem', fontWeight: 800, backdropFilter: 'blur(10px)',
                    boxShadow: (academy as any)?.estado_aprobacion === 'aprobado' ? '0 4px 16px rgba(16,185,129,0.4)' : '0 4px 16px rgba(30,136,229,0.4)',
