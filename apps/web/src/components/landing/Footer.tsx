...
export function Footer({
  ...
  return (
    <footer className="landing-footer" role="contentinfo" aria-label="Pie de página Donde Bailar MX">
      ...
      <div className="landing-container landing-footer__wrap">
        <div className="landing-footer__top">
          ...
          <aside className="landing-footer__cta" aria-label="Descargar app">
            <button type="button" className="landing-footer__ctaPrimary" onClick={handleDownload}>
        ...
        <div className="landing-footer__bottom" aria-label="Copyright y redes">
