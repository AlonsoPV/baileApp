...
- **Autenticación:** Requerida
- **Descripción:** Edición completa del evento con datos pre-cargados
- **Campos:** Todos los campos con valores actuales
- **Características:**
  - Carga datos existentes automáticamente
  - Guardado independiente de evento padre y fecha
  - Invalidación de caché para actualización inmediata
