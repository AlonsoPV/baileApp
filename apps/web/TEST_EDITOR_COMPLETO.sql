-- ============================================
-- TEST: Editor Completo
-- Script para probar la funcionalidad del editor
-- ============================================
...
-- 2) Agregar respuestas de ejemplo para las preguntas
...
-- 3) Agregar fotos de ejemplo en los slots específicos
UPDATE public.profiles_user 
...
-- 5) Mostrar todas las fotos por slot
SELECT 
    value->>'slot' as slot,
